const snapshotTiles = [
  ...
  const trendRows = [
    { model: 'GPT-5', change: '+1.2%', positive: true, prev: '90.8%', now: '92.0%', barWidth: 92 },
    { model: 'Claude 4 Opus', change: '-0.8%', positive: false, prev: '93.2%', now: '92.4%', barWidth: 92 },
    { model: 'Gemini 2 Ultra', change: '+2.4%', positive: true, prev: '88.1%', now: '90.5%', barWidth: 90 },
    { model: 'Llama 3.1', change: '+0.6%', positive: true, prev: '84.2%', now: '84.8%', barWidth: 85 },
  ];
              ...
              {trendRows.map((row) => (
                <div key={row.model}>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span style={{ color: row.positive ? '#16a34a' : '#dc2626' }} className="text-sm font-medium">
                      {row.change}
                    </span>
                  </div>
                  <div style={{ width: '100%', height: '6px', backgroundColor: '#f3f4f6', borderRadius: '9999px', overflow: 'hidden' }}>
                    <div
                      style={{
                        width: row.barWidth + '%',
                        height: '6px',
                        backgroundColor: row.positive ? '#22c55e' : '#ef4444',
                        borderRadius: '9999px'
                      }}
                    />
                  </div>
